...
<div class="card shadow-sm border-0 p-4">
    ...
    <form method="post">
        <div class="row g-3">
            ...
            <div class="col-md-6"><label class="form-label">Theme Color</label><input type="color" name="theme_color" class="form-control form-control-color" value="<?= htmlspecialchars($settings['theme_color'] ?? '#2563eb', ENT_QUOTES, 'UTF-8') ?>"></div>
