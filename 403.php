    ...
    <div class="container d-flex align-items-center justify-content-center min-vh-100">
        <div class="card auth-card shadow-sm border-0 p-4 text-center">
            <div class="brand-logo mx-auto mb-3">
                <img src="<?= url('/assets/images/image.png') ?>" alt="AIML AcademicHub Logo" class="img-fluid" style="max-width: 100px;">
            </div>
            ...
            <a href="<?= url('/auth/login.php') ?>" class="btn btn-primary">Back to login</a>
        </div>
    </div>
</body>
</html>
