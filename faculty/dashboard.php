            ...
            <div class="row g-4 max-width-600 mx-auto mb-4">
                <div class="col-md-6">
                    <div class="card p-3 border shadow-sm h-100">
                        ...
                        <p class="small text-muted">Allocate guides, approve proposals, and verify student milestones.</p>
                        <a href="<?= url('/project-internships/') ?>" class="btn btn-primary btn-sm mt-auto">Open Faculty Portal</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="card p-3 border shadow-sm h-100">
                        <h5><i class="bi bi-briefcase text-success fs-3 d-block mb-2"></i> Placements (TPO)</h5>
                        <p class="small text-muted">Track drives, student registrations, eligibility status.</p>
