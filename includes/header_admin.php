        ...
        <nav class="navbar navbar-expand-lg bg-white border-bottom px-4 py-3 shadow-sm">
            <div class="d-flex justify-content-between w-100 align-items-center">
                ...
                <div class="d-flex align-items-center gap-3">
                    <span class="badge bg-primary"><?= htmlspecialchars($user['role_name'] ?? $user['role'] ?? 'Admin', ENT_QUOTES, 'UTF-8') ?></span>
                    <span class="fw-semibold"><?= htmlspecialchars($user['full_name'] ?? $user['name'] ?? 'Administrator', ENT_QUOTES, 'UTF-8') ?></span>
